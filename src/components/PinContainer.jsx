    ...
    (<a
      ...
      <div
        ...
        <div
          ...
          className="absolute left-1/2 p-4 top-1/2 flex justify-start items-start rounded-xl shadow-[1px_16px_rgb(0_0_0/0.4)] bg-zinc-900 border-3 border-white/20 group-hover/pin:border-white/50 transition duration-700 overflow-hidden">
