...
export const PinContainer = ({
  ...
  return (
    ...
    >
      {/* Add background effect div */}
      <div className="absolute inset-0 bg-[#00c8e8]/10 rounded-xl blur-xl opacity-50" />
      ...
      >
        <div
          ...
          className="absolute left-1/2 p-2 top-1/2 flex justify-start items-start rounded-2xl shadow-[1px_16px_rgb(0_0_0/0.4)] backdrop-blur-md bg-white/[0.03] border border-white/[0.08] group-hover/pin:border-white/50 transition duration-700 overflow-hidden"
        >
